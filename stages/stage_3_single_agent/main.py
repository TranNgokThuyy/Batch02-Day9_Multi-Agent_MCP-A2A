...
SYSTEM_PROMPT = (
    ...
    "calculating penalties, checking compliance requirements, and searching case law. Use these tools to build "
    "a comprehensive analysis. Search for each legal area separately — data privacy, tax, "
    "compliance, and relevant case law for contract breach issues. Keep your final answer under 500 words."
)
